...
import {
  createExampleOracle,
  OracleErrorCodes,
} from '../fixtures/ExampleOracleFixture';
...
describe('test example oracle', () => {
  ...
  test('update', async () => {
    ...
    async function test(
      fixture: ContractFixture<ExampleOracleSimpleTypes.Fields>,
    ...
    expectAssertionError(
      test(fixture0, timestamp0),
      fixture0.address,
      OracleErrorCodes.PeriodNotElapsed
    );
    ...
    const exampleOracleState =
      getContractState<ExampleOracleSimpleTypes.Fields>(
        result.contracts,
        fixture1.contractId
      );
